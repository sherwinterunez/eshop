...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setHeader("#master_checkbox, Seq, Date/Time, User, Total, &nbsp;");

			myGrid.setInitWidths("50,50,200,200,200,*");

			myGrid.setColAlign("center,center,left,left,right,*");

			myGrid.setColTypes("ch,ro,ro,ro,ron,*");
			...
			/*myGrid._in_header_stat_sum = function(tag,index,data){
			    var calck=function(){
			        ...
			        this.forEachRow(function(id){
			        	console.log(id,this.cellById(id,index).getValue());
			...
			try {
				...
				if(ddata.rows[0].id) {
					...
					myGrid.attachHeader("&nbsp;,&nbsp;,#combo_filter,#combo_filter,#text_filter,#text_filter");
