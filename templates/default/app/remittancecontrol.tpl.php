...
//////////
	...
	function doSelect_%formval%(id, lastId){
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			odata: {},
			pdata: "routerid="+settings.router_id+"&action=formonly&formid=remittancemain"+id+"&module=remittance&formval=%formval%",
		}, function(ddata,odata){
			if(ddata.html) {
				jQuery("#formdiv_%formval% #remittancemain").parent().html(ddata.html);				
			}
		});
