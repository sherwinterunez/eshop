...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setHeader("#master_checkbox,ID, Document Date, Document No., Customer, Total Amount Due, Total Amount Paid, Balance, Status");

			myGrid.setInitWidths("50,70,140,140,*,140,140,140,120");

			myGrid.setColAlign("center,left,left,left,left,right,right,right,center");
			...
			try {
				...
				if(ddata.rows[0].id) {
					...
					myGrid.attachEvent("onRowDblClicked", function(rowId,cellIndex){
						...
						obj.title = 'Payment / '+myGrid.cells(rowId,2).getValue()+' / '+myGrid.cells(rowId,3).getValue()+' / '+myGrid.cells(rowId,4).getValue();
