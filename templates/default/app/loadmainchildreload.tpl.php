...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setHeader("#master_checkbox, ID, Receipt Date, Receipt No, From Parent, Mobile Number, To Child, Mobile Number, Amount, Status");
			...
			try {
				...
				if(ddata.rows[0].id) {
					...
					myGrid.attachEvent("onRowDblClicked", function(rowId,cellIndex){
						...
						obj.title = 'Fund Reload / '+myGrid.cells(rowId,3).getValue()+' / '+myGrid.cells(rowId,5).getValue();
