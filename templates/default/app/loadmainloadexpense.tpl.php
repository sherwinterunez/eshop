...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setHeader("#master_checkbox, ID, Receipt Date, Receipt No, Provider, Assigned SIM Card to Receive Load, Quantity, Discount, Amount Due, Status");

			myGrid.setInitWidths("50,70,120,120,150,*,100,100,100,100");
