...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setHeader("#master_checkbox,ID, Prefix, Provider, Created, Updated");

			myGrid.attachHeader("&nbsp;,&nbsp;,#text_filter,#combo_filter,&nbsp;,&nbsp;");

			myGrid.setInitWidths("50,70,250,*,120,120");
			...
			try {
				...
				if(ddata.rows[0].id) {
					...
					myGrid.attachEvent("onRowDblClicked", function(rowId,cellIndex){
						...
						obj.title = 'Network Prefix / '+myGrid.cells(rowId,2).getValue();
