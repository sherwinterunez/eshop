...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			<?php /* ?>
			myGrid.setHeader("#master_checkbox,ID, Priority, Key#1, Key#2, Key#3, Key#4, Key#5, Active");

			myGrid.setInitWidths("50,50,100,200,200,200,200,200,200");

			myGrid.setColAlign("center,center,center,left,left,left,left,left,center");

			myGrid.setColTypes("ch,ro,ro,ro,ro,ro,ro,ro,ro");

			myGrid.setColSorting("int,int,int,str,str,str,str,str,str");
			<?php */ ?>

			myGrid.setHeader("#master_checkbox,ID, Priority, Name, Active");

			myGrid.setInitWidths("50,50,100,*,*");
			...
			try {
				...
				if(ddata.rows[0].id) {
					...
					myGrid.attachEvent("onRowDblClicked", function(rowId,cellIndex){
						...
						obj.title = 'Load Command / '+myGrid.cells(rowId,2).getValue();
