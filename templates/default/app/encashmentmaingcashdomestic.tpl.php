...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setHeader("#master_checkbox, ID, Receipt Date, Receipt No, Customer Name, Mobile Number, Recipient Name, SmartMoney Number, Amount, Service Charge, Transfer Fee, Processing Fee, Amount Due, Status");

			myGrid.setInitWidths("50,70,90,90,*,90,*,*,90,90,90,90,90,80");

			myGrid.setColAlign("center,center,left,left,left,left,left,left,left,left,left,left,left,left");
