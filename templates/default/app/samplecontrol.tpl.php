...
////////
		...
		if($("#formdiv_%formval% #loadmainretailgrid").length) {

			$("#formdiv_%formval% #loadmainretailgrid").height(lbHeight-90);
			$("#formdiv_%formval% #loadmainretailgrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #loaddetailretail").length) {

			$("#formdiv_%formval% #loaddetailretail").height(lcHeight-2);
			$("#formdiv_%formval% #loaddetailretail").width(lcWidth-2);

			$("#formdiv_%formval% #loaddetailretaildetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #loaddetailretaildetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #loadmaindealergrid").length) {

			$("#formdiv_%formval% #loadmaindealergrid").height(lbHeight-90);
			$("#formdiv_%formval% #loadmaindealergrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #loaddetaildealer").length) {

			$("#formdiv_%formval% #loaddetaildealer").height(lcHeight-2);
			$("#formdiv_%formval% #loaddetaildealer").width(lcWidth-2);

			$("#formdiv_%formval% #loaddetaildealerdetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #loaddetaildealerdetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #loadmainfundreloadgrid").length) {

			$("#formdiv_%formval% #loadmainfundreloadgrid").height(lbHeight-90);
			$("#formdiv_%formval% #loadmainfundreloadgrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #loaddetailfundreload").length) {

			$("#formdiv_%formval% #loaddetailfundreload").height(lcHeight-2);
			$("#formdiv_%formval% #loaddetailfundreload").width(lcWidth-2);

			$("#formdiv_%formval% #loaddetailfundreloaddetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #loaddetailfundreloaddetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #loadmainfundtransfergrid").length) {

			$("#formdiv_%formval% #loadmainfundtransfergrid").height(lbHeight-90);
			$("#formdiv_%formval% #loadmainfundtransfergrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #loaddetailfundtransfer").length) {

			$("#formdiv_%formval% #loaddetailfundtransfer").height(lcHeight-2);
			$("#formdiv_%formval% #loaddetailfundtransfer").width(lcWidth-2);

			$("#formdiv_%formval% #loaddetailfundtransferdetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #loaddetailfundtransferdetailsform_%formval%").width(lcWidth-22);
		}
...
////////
	...
	function explorer_sidebar_%formval%(){
		...
		mySideBar = mySideBar_%formval% = myTab.layout.cells('a').attachSidebar({
			...
			items: [
					{id: "retail", text: "Retail", icon: "recent.png"},
					{id: "dealer", text: "Dealer", icon: "desktop.png"},
	...
	function doSelect_%formval%(id, lastId){
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			odata: {},
			pdata: "routerid="+settings.router_id+"&action=formonly&formid=samplemain"+id+"&module=sample&formval=%formval%",
		}, function(ddata,odata){
			if(ddata.html) {
				jQuery("#formdiv_%formval% #samplemain").parent().html(ddata.html);				
			}
		});
