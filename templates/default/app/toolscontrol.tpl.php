...
////////
		...
		if($("#formdiv_%formval% #<?php echo $templatemainid; ?>taskgrid").length) {

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>taskgrid").height(lbHeight-90);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>taskgrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #<?php echo $templatedetailid; ?>task").length) {

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>task").height(lcHeight-2);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>task").width(lcWidth-2);

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>taskdetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>taskdetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #<?php echo $templatemainid; ?>runcommandgrid").length) {

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>runcommandgrid").height(lbHeight-90);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>runcommandgrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #<?php echo $templatedetailid; ?>runcommand").length) {

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>runcommand").height(lcHeight-2);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>runcommand").width(lcWidth-2);

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>runcommanddetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>runcommanddetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #<?php echo $templatemainid; ?>archivegrid").length) {

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>archivegrid").height(lbHeight-90);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>archivegrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #<?php echo $templatedetailid; ?>archive").length) {

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>archive").height(lcHeight-2);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>archive").width(lcWidth-2);

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>archivedetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>archivedetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #<?php echo $templatemainid; ?>backuprestoregrid").length) {

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>backuprestoregrid").height(lbHeight-90);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>backuprestoregrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #<?php echo $templatedetailid; ?>backuprestore").length) {

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>backuprestore").height(lcHeight-2);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>backuprestore").width(lcWidth-2);

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>backuprestoredetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>backuprestoredetailsform_%formval%").width(lcWidth-22);
		}
...
////////
	...
	function explorer_sidebar_%formval%(){
		...
		mySideBar = mySideBar_%formval% = myTab.layout.cells('a').attachSidebar({
			...
			items: [
					{id: "task", text: "Task", icon: "recent.png"},
					{id: "runcommand", text: "Run AT Command", icon: "desktop.png"},
					{id: "archive", text: "Archive", icon: "downloads.png"},
					{id: "backuprestore", text: "Backup&Restore", icon: "documents.png"},
	...
	function doSelect_%formval%(id, lastId){
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			odata: {},
			pdata: "routerid="+settings.router_id+"&action=formonly&formid=toolsmain"+id+"&module=tools&formval=%formval%",
		}, function(ddata,odata){
			if(ddata.html) {
				jQuery("#formdiv_%formval% #toolsmain").parent().html(ddata.html);				
			}
		});
