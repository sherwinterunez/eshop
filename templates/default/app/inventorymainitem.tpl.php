...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setInitWidths("50,100,*,120,180,180,120,120,80");

			myGrid.setColAlign("center,center,left,left,left,left,right,right,center");

			myGrid.setColTypes("ch,ro,ro,ro,ro,ro,ron,ron,ro");
