...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setHeader("#master_checkbox,ID, Priority, Description, Category, Active");

			myGrid.setInitWidths("50,50,100,*,*,100");

			myGrid.setColAlign("center,center,center,left,left,center");

			myGrid.setColTypes("ch,ro,ro,ro,ro,ro");

			myGrid.setColSorting("int,int,int,str,str,str");
			...
			try {
				...
				if(ddata.rows[0].id) {
					...
					myGrid.attachEvent("onRowDblClicked", function(rowId,cellIndex){
						...
						obj.title = 'Expression / '+myGrid.cells(rowId,2).getValue();
