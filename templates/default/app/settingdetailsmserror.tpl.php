...
///////////////////////////////////
		...
		var smscommands_notification0opt = <?php echo json_encode($params['smscommands_notification0opt']); ?>

		var dhxCombo = myForm.getCombo('smscommands_notification0');
		...
		dhxCombo.addOption(smscommands_notification0opt.opts);
	    dhxCombo.setComboText(smscommands_notification0opt.value);
	    dhxCombo.setComboValue(smscommands_notification0opt.value);
