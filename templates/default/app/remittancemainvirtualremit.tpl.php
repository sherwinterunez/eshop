...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setHeader("#master_checkbox, ID, Receipt Date, Receipt No, Customer Name, Mobile Number, Recipient Name, Recipient Number, Amount, Service Charge, Transfer Fee, Processing Fee, Amount Due, Status");
