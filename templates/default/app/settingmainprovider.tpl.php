...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setHeader("#master_checkbox,ID, Name, Description, Created, Updated");

			myGrid.setInitWidths("50,70,300,*,120,120");
			...
			try {
				...
				if(ddata.rows[0].id) {
					...
					myGrid.attachEvent("onRowDblClicked", function(rowId,cellIndex){
						...
						obj.title = 'Provider / '+myGrid.cells(rowId,2).getValue();
