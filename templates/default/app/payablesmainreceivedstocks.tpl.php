...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setHeader("#master_checkbox,ID, Received Stock Date, Received Stock No., Supplier, Status");
			...
			try {
				...
				if(ddata.rows[0].id) {
					...
					myGrid.attachEvent("onRowDblClicked", function(rowId,cellIndex){
						...
						obj.title = 'Received Stock / '+myGrid.cells(rowId,2).getValue()+' / '+myGrid.cells(rowId,3).getValue()+' / '+myGrid.cells(rowId,4).getValue();
