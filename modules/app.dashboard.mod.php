...
if(!class_exists('APP_app_dashboard')) {

	class APP_app_dashboard extends APP_Base_Ajax {
	
		var $desc = 'Dashboard';

		var $pathid = 'dashboard';
		var $parent = false;
		...
		function add_rules() {
			...
			$appaccess->rules($this->desc,'Dashboard Module');
	...
	$appappdashboard = new APP_app_dashboard;
}
