...
if(!class_exists('APP_app_reports')) {

	class APP_app_reports extends APP_Base_Ajax {
		...
		function add_rules() {
			...
			$appaccess->rules($this->desc,'Reports Module');
		...
		function _form_reportsmainreportsetting($routerid=false,$formid=false) {
		...
		} // _form_reportsmainreportsetting

		function _form_reportsmainreporttocsv($routerid=false,$formid=false) {
			global $applogin, $toolbars, $forms, $apptemplate, $appdb;
		...
		} // _form_reportsmainreporttocsv

		function _form_reportsdetailreportsetting($routerid=false,$formid=false) {
			global $applogin, $toolbars, $forms, $apptemplate, $appdb;
			...
			if(!empty($routerid)&&!empty($formid)) {
				...
				if(!empty($this->vars['post']['method'])&&($this->vars['post']['method']=='reportsnew'||$this->vars['post']['method']=='reportsedit')) {
					$readonly = false;
				}
...
*/
		...
		} // _form_reportsdetailreportsetting

		function _form_reportsdetailreporttocsv($routerid=false,$formid=false) {
			global $applogin, $toolbars, $forms, $apptemplate, $appdb;
...
*/
		...
		} // _form_reportsdetailreporttocsv
	...
	$appappreports = new APP_app_reports;
}
